...
import {Animated,PanResponder,StyleSheet,Text,View,TouchableOpacity,Modal, Easing,ScrollView,TextInput, Image,FlatList} from 'react-native';
...
export const AnalisisRegistroPaciente=(props)=>{
  ...
  const panResponder=PanResponder.create({
    ...
    onPanResponderRelease:()=>{setPreviousPinchDistance(null)},
            ...
            <View style={{flex:4}}>
                ...
                <View >
                    ...
                    {registro.foto&&
                      ...
                      <Image {...panResponder.panHandlers} source={{uri:(registro.foto)}} style={{transform:[{scale:scale}],alignSelf: 'center', width: 300, height: 300, borderWidth: 2,borderColor: 'white', borderRadius:15, margin:5}}/>
                    </View>} 
                  </View>
                </View>
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <View>
                      {item.idRegistroComida && (
                        <View  style={{backgroundColor:"white",borderColor:"#76C893",padding:15,margin:10,borderRadius:15,borderWidth:2,padding:15, marginVertical: 5, alignItems: "center", justifyContent: "center",alignItems:"stretch", borderRadius:25}}>
