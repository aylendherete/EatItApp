    ...
    <View style={styles.fondoVerde}>
      ...
      <View style={{flex:4}}>
        ...
        <Modal visible={showAlert} transparent animationType="slide" >
          ...
          >
          <Animated.View style={{backgroundColor:"#76C893", padding: 25, borderRadius: 15,
              opacity: opacity,
        ...
        <Modal visible={showTick} transparent>
          ...
          <Animatable.View animation="zoomIn" duration={900} >
            
            <View style={{backgroundColor:"green" ,width:"100%",height:"100%", justifyContent:"center"}}>
