...
import { CalendarioPaciente, MiPerfil, NotificacionesPaciente, RegistroComentado, RegistroComida, RegistroTipoActividad, RegistroTipoAgua, RegistroTipoComida, TurnosPaciente } from './screens';
...
export const Paciente=()=>{
  ...
  return(
    ...
    <Tab.Navigator>
        ...
        <Tab.Screen name="CalendarioPacienteStack" component={StackCalendarioPaciente} options={{
          headerShown:false, 
          tabBarShowLabel:false,
          tabBarIcon:()=>(
