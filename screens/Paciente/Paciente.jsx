...
import { CalendarioPaciente, MiPerfil, NotificacionesPaciente, RegistroComentado, RegistroComida, RegistroTipoActividad, RegistroTipoAgua, RegistroTipoComida } from './screens';
...
export const Paciente=()=>{
  ...
  return(
    ...
    <Tab.Navigator>
        ...
        <Tab.Screen name="CalendarioPaciente" component={CalendarioPaciente} options={{
          headerShown:false, 
          tabBarShowLabel:false,
          tabBarIcon:()=>(
